...
const Hero: React.FC = () => {
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-rose-50 via-orange-50 to-amber-50 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center z-10 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
        <div className="mb-8">
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-rose-600 to-amber-600 mx-auto mb-6" />
          <p className="text-base sm:text-lg text-gray-700 leading-normal sm:leading-relaxed max-w-2xl mx-auto mb-10">
